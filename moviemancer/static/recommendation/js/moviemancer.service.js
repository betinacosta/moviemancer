...
angular.module('Moviemancer')
    ...
    .factory('MoviemancerService', ['$http', '$rootScope', '$window', function ($http, $rootScope, $window) {
        ...
        service.handleFilters = function (genres, yearMin, yearMax, runtimeMin, runtimeMax, languages, discover, recommendation) {
            var selectedGenres = [];
            ...
            $window.location.href = '#/filtersview/' + selectedGenres + '/' + selectedLanguage + '/' + selectedMinYear + '/' + selectedMaxYear + '/' + runtimeMin + '/' + runtimeMax + '/' + discover + '/' + recommendation;
        }
